window.onload = () => {
    ...
    areaOfTriangleAction.onclick = () => {
        const areaOfTriangleInputBase = document.getElementById('area-of-triangle-input-1');
        const areaOfTriangleInputHeight = document.getElementById('area-of-triangle-input-2');
